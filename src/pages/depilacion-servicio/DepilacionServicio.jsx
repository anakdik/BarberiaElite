      ...
      <div className="overlay">
        <div className="contenedor-servicio">
          ...
          <div className="servicio-info">
            ...
            <p>
              Aplicar cera caliente o tibia sobre zonas con vello no deseado,
              retirándola de raíz.
            </p>
            <hr />
            <div className="item">
              <img src={valor} alt="Valor" />
              <span><b>Valor del servicio:</b> 15.000 pesos</span>
            </div>
            <div className="item">
...
export default DepilacionServicio;
