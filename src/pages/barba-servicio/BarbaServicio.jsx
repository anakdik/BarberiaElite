      ...
      <div className="overlay">
        <div className="contenedor-servicio">
          ...
          <div className="servicio-info">
            ...
            <h2>Barba</h2>
            <p>
              Recortar, dar forma y perfilar la barba, para lograr un acabado limpio y simétrico.
            </p>
            <hr />
            <div className="item">
              <img src={valor} alt="Valor" />
              <span><b>Valor del servicio:</b> 20.000 pesos</span>
            </div>
            <div className="item">
