        ...
        <div className="contenedor-servicio">
          ...
          <div className="servicio-info">
            ...
            <p>
              ...
              utilizando tijeras, máquina y navaja para definir contornos y lograr
              un acabado limpio y prolijo.
            </p>
            <hr />
            <div className="item">
              <img src={valor} alt="Valor" />
              <span><b>Valor del servicio:</b> 35.000 pesos</span>
            </div>
            <div className="item">
...
export default CorteBarbaServicio;
